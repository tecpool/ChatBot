...
public class ChatBotAdapter extends RecyclerView.Adapter<ChatBotAdapter.MyViewHolderH> {
    ...
    public class MyViewHolderH extends RecyclerView.ViewHolder {
        ...
        public MyViewHolderH(View view) {
            ...
            wait=(WebView) view.findViewById(R.id.wait);

            wait.getSettings().setJavaScriptEnabled(true);
            wait.setHorizontalScrollBarEnabled(false);
            wait.setVerticalScrollBarEnabled(false);
    ...
    public void onBindViewHolder(final MyViewHolderH holder, final int position) {
        ...
        holder.wait.loadDataWithBaseURL(null, pre+"file:///android_res/drawable/wait.gif"+post, "text/html", "utf-8", null);
